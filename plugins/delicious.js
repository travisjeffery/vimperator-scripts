...
// Modified by: Egon Hyszczak <gone404@gmail.com> Added private bookmarks (pvt) and Twitter functionality (for:@twitter)

commands.addUserCommand(['delicious'], "Save page as a bookmark on Delicious ('pvt': privacy, 'for:@twitter': Twitter)",
    function(args) {
